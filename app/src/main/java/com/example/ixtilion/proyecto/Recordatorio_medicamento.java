...
public class Recordatorio_medicamento {
    ...
    public Recordatorio_medicamento(Medicamento medicamento, Date fecha_ini, Date fecha_fin, int intervalo, float cantidadToma, String id){
    ...
    public Recordatorio_medicamento(Medicamento medicamento, Date fecha_ini, Date fecha_fin, int intervalo, float cantidadToma, String id, String descripcion, int diasTomaMes, int diasDescansoMes){
        this.medicamento=medicamento;
        this.fecha_ini=fecha_ini;
        this.fecha_fin=fecha_fin;
        this.intervalo=intervalo;
